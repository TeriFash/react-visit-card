...
class AppHome extends Component {
  ...
  render() {
    ...
    return <section className="App-wrapper" onMouseMove={this.onMouseMove.bind(this)} style={sectionStyle}>

      <h1 className="Main-text" ref="section">Teri
        <span className="bold" ref="playword_1" style={boldStyle}>Fash</span>
        <span className="bold" ref="playword_2" style={boldStyle}>.</span>
      </h1>
