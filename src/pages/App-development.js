...
class AppDevelopment extends Component {
  ...
  render() {
   return <section className="Development-page">
        ...
        <h1 className="Development-page-text">
            Development
        </h1>
...
function AppDevelopmentMy() {
  ...
  return <animated.div className="Container" style={{ ...rest, width: size, height: size }} onClick={() => set(open => !open)}>
